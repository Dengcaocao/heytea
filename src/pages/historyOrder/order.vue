		...
		<view class="wrap">
			<swiper class="swiper-box" :current="swiperCurrent">
				<swiper-item class="swiper-item">
                  ...
                  <view class="goods-list flex-align text-hide">
                    <view class="good-item" v-for="(item, index) in res.goodsList" :key="index">
                      <view class="left"><image :src="item.goodsUrl" mode="aspectFill"></image></view>
                      <view class="content">
                        <view class="title u-line-1">{{ item.title }}</view>
                        <!-- <view class="good-info flex-content">
                          <view class="price">￥{{ priceInt(item.price) }}</view>
                  ...
                  <view class="total">
                    ...
                    <view class="totalNum">共{{ totalNum(res.goodsList) }}件商品</view>
                  </view>
								</view>
								<view class="bottom">
									<view class="more"><u-icon name="more-dot-fill" color="rgb(203,203,203)"></u-icon></view>
									<view class="logistics btn">查看物流</view>
									<view class="exchange btn">小票</view>
